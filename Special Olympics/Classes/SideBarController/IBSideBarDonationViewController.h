//
//  IBSideBarDonationViewController.h
//  iBuddyClient
//
...
@interface IBSideBarDonationViewController : CustomFormViewController <BSKeyboardControlsDelegate>
{
...
@property(nonatomic,strong) NSString *strPaymentToken;
/**
